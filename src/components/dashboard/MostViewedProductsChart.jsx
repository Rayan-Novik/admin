...
const MostViewedProductsChart = ({ dateRange }) => {
    ...
    // 🟢 NOVO PLUGIN: Desenha as imagens no eixo Y (Esquerda)
    ...
    const options = {
        ...
        plugins: {
            ...
            tooltip: {
                ...
                borderColor: '#e2e8f0',
                borderWidth: 1,
                callbacks: { label: (c) => ` ${c.parsed.x} views` }
            }
        },
        scales: {
            x: {
            ...
            y: {
                ...
                ticks: { 
                    ...
                    color: '#64748b',
                    padding: 42, // 🟢 Cria espaço para a imagem
    ...
    return (
        <>
            {/* Adicionado "clean-card most-viewed-card mb-4" na div principal */}
            <div className="clean-card most-viewed-card d-flex flex-column h-100 p-4 mb-4">
                <div className="section-title mb-4 d-flex justify-content-between align-items-center">
                    <div className="most-viewed-title">
                        <i className="bi bi-eye me-2 text-muted title-icon"></i>
            ...
            {/* MODAL DETALHADO OCULTO P/ ECONOMIZAR ESPAÇO */}
                            ...
                            <div className="d-flex align-items-center position-relative" style={{ zIndex: 1 }}>
                                ...
                                <div className="text-end d-none d-md-block ps-3 border-start border-white border-opacity-25">
                                    <div className="d-flex align-items-center justify-content-end mb-1">
                                        <small className="opacity-75 text-uppercase fw-medium me-1" style={{fontSize: '11px'}}>Total Views</small>
                                    </div>
            ...
            <style>{`
                ...
                .mobile-dashboard-wrapper .most-viewed-card {
                    padding: 25px 20px !important;
                }
                .mobile-dashboard-wrapper .most-viewed-title {
