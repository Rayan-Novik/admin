...
const SideBannerManager = () => {
    ...
    const fetchBanners = async () => {
        try {
            ...
            // 🟢 Blindagem: Se der erro (404 vazio ou 403 sem permissão), limpa a lista e não quebra a tela!
            setBanners([]);
            console.log("Nenhum banner lateral encontrado ou acesso bloqueado.");
        } finally { 
            setLoading(false); 
        }
    };
