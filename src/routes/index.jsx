                ...
                <Route path="*" element={
                    <AdminLayout onLogout={handleLogout}>
                        <Routes>
                            ...
                            {/* CONFIGURAÇÕES DA LOJA (Desmembradas) */}
                            ...
                            {/* 🟢 MÓDULO FISCAL */}
                            <Route path="/admin/notas-fiscais" element={<PrivateRoute requiredPermission="FINANCEIRO_VIEW"><ListaNotasFiscais /></PrivateRoute>} />
                            <Route path="/admin/notas-entrada" element={<PrivateRoute requiredPermission="ESTOQUE_MANAGE"><ImportadorXml /></PrivateRoute>} />
                            <Route path="/admin/nfce/:id" element={<PrivateRoute requiredPermission="FINANCEIRO_VIEW"><NfceView /></PrivateRoute>} />
                            <Route path="/admin/config-fiscal" element={<PrivateRoute requiredPermission="CONFIG_INTEGRATIONS"><ConfiguracoesFiscais /></PrivateRoute>} />
                            <Route path="/admin/danfe/:id" element={<PrivateRoute requiredPermission="FINANCEIRO_VIEW"><DanfeView /></PrivateRoute>} />

                            {/* MASTER SAAS (Apenas Dono do Tenant 1) */}
